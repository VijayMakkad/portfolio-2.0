...
export const Footer = () => {
    return (
      <div className="space-y-3 p-4 md:p-8 bg-white dark:bg-zinc-800/50 rounded-lg">
        {/* CTA Section */}
        <div className="text-center space-y-4 mb-6 md:mb-10">
          <h2 className="text-3xl md:text-4xl font-semibold text-zinc-900 dark:text-white">Let's work together.</h2>
          ...
          <div className="flex justify-center gap-2 md:gap-3 mt-4 md:mt-6">
            <Button size="sm" className="bg-zinc-200 dark:bg-zinc-700 hover:bg-zinc-300 dark:hover:bg-zinc-600 text-zinc-900 dark:text-white">
              <span className="text-lg">+</span> Hire Me
            </Button>
            <Button size="sm" variant="outline" className="border-zinc-300 dark:border-zinc-700 text-zinc-900 dark:text-white hover:bg-zinc-100 dark:hover:bg-zinc-700/50 items-center justify-center">
              <span className="text-lg">□</span> Copy Email
            </Button>
          </div>
        </div>
        ...
        <div className="text-center p-4 bg-zinc-100/90 dark:bg-zinc-800/90 rounded-lg">
          ...
          <p className="text-zinc-500 dark:text-gray-500 text-sm">
            by{' '}
            <a href="#" className="underline hover:text-zinc-700 dark:hover:text-gray-400">
              Vijay Makkad
            </a>
          </p>
        </div>
